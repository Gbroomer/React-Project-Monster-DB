...
function MonsterContainer({ monsters, selectMonster }) {
    ...
    const [crSwitch, setCrSwitch] = useState(false)
    ...
    return (
        <div className="allMonsters">
            ...
            <br />
            <FilterButtons addSelectedType={addSelectedType} removeSelectedType={removeSelectedType} monsters={monsters} uniqueTypes={uniqueTypes} selectMonster={selectMonster} crSwitch={handleCrSwitch} />
            <br />
            <br />
            {eachMonster}
        </div>
